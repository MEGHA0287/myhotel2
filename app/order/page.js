...
const Billing = ({ tableId, acPercentage }) => {
  ...
  const [lastAllOrders, setLastAllOrders] =
    useState([]);
...
<p style="${!hotelInfo || !hotelInfo.fssaiNo ? "display: none;" : ""
        ...
        <div class="tableno reduce-space">
          <div class="billNo">
            <p>Bill No: ${orderNumber.slice(5)}</p>
          </div>
  ...
  <div class="footer">
    <p>
      <span class="big-text">Thank you! Visit again!!!</span>
      <br class="brab">
      ...
      <div className="container mx-auto  bg-white">
        <div className="flex lg:flex-row  shadow-lg ">
          ...
          <div className="w-1/2 lg:w-3/5 min-h-screen shadow-lg ">
            ...
            {/* <!-- categories --> */}
            <div className="mt-5 flex flex-row px-2 ml-1 custom-scrollbars overflow-x-auto whitespace-nowrap">
              <span
                key="all-items"
            ...
            <div className="cursor-pointer grid grid-cols-2 bg-white  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 px-5 mt-5 custom-sidescrollbars overflow-scroll max-h-[calc(75vh-2rem)]  shadow-md-">
              {(menus.menus || menus)
          ...
          <div className="w-1/2 lg:w-2/5  bg-gray-200">
            ...
            {/* <!-- end total --> */}
              ...
              <div className="flex px-5 mt-2 justify-between ">
                <div
                  className="px-4 py-2 rounded-md shadow-lg text-center bg-yellow-100 text-yellow-500 font-bold cursor-pointer text-base"
                  onClick={saveBill}
                >
                  KOT
                </div>
