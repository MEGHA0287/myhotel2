          ...
          <div className="w-1/2 lg:w-2/5 mt-2  bg-indigo-100">
            ...
            <div className=" border-t-2">
              ...
              <div className="flex px-5 mt-2 justify-between">
                <div
                  className="w-1/3 py-2 rounded-md shadow-lg text-center bg-green-500 text-white font-semibold cursor-pointer text-sm"
                  onClick={handlePrintBill}
                >
                  Print
                </div>
                <div
                  className="w-1/3  py-2 rounded-md shadow-lg text-center bg-yellow-500 text-white font-semibold cursor-pointer text-sm"
